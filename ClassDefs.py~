...
class WFC3SpecFit():
    ...
    def GPMBundle( self, dset, parents ):
        ...
        ixs0 = np.arange( self.ndat[dset] )
        scanixs = {}
        scanixs['f'] = ixs0[slcs[dset].scandirs==1]
        scanixs['b'] = ixs0[slcs[dset].scandirs==-1]
    ...
    def GetModelComponents( self, dset, parents, scanixs, scankey ):
        ...
        """
        slcs = self.slcs[dset]
        idkey = '{0}{1}'.format( wlc.dsetname, scankey )
...
class WFC3WhiteFit():
    ...
    def GPMBundleBACKUP( self, dset, zplanet, Tmid ):
        ...
        cullixs_final = []
        for k in self.scankeys[dset]:
            idkeyk = '{0}{1}'.format( wlc.dsetname, k )
